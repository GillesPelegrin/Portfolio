    ...
    <div className="mx-4 flex min-h-[66%] items-center  justify-center md:mx-20 xl:mx-40">
      <div className="order-2  flex flex-col-reverse content-center  justify-center lg:flex-grow  lg:flex-row lg:justify-between">
        <div className="mt-14 text-center lg:text-left">
          <div className="bg-gradient-to-r from-red-400 to-primary bg-clip-text font-sans text-4xl font-semibold text-transparent lg:text-5xl xl:text-6xl">
            Full stack developer
          </div>
          <div className="font-serif text-2xl font-bold text-color-title lg:text-3xl xl:text-4xl">
