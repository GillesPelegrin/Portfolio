...
export default function Navbar() {
    ...
    return (
        <>
            <nav
                className="mx-4 flex h-1/6  justify-between font-sans font-semibold text-color-title md:mx-10 lg:mx-20">
            ...
            {openMobileNav && (
                <div
                    className="absolute inset-x-0 mx-4 my-4 block cursor-pointer  bg-white  font-sans font-semibold shadow-lg md:hidden">
