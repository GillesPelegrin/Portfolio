  ...
  return (
    <>
      <div className="mx-3 flex min-h-[66%] flex-col items-center justify-center gap-8 md:mx-6 md:gap-10 lg:mx-20 lg:flex-grow lg:flex-row lg:justify-between 2xl:mx-40">
        ...
        <div>
          <div className=" cursor-pointer rounded border border-4 border-white p-4   text-color-title shadow-card  hover:border-primary hover:shadow-none md:p-8 2xl:p-10">
          ...
          <div className=" mt-6 cursor-pointer rounded border border-4 border-white p-4 text-color-title  shadow-card hover:border-primary hover:shadow-none md:p-8 2xl:p-10 ">
